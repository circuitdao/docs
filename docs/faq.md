...
You can head over directly to the [app](https://app.circuitdao.com), or check out our [Getting Started](../category/getting-started) guide first.
...
You can obtain BYC by borrowing it directly from the protocol. The [Getting Started](../category/getting-started) guide shows you how.
