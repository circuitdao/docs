...
You can earn yield by depositing BYC in a savings vault on the [Earn page](https://app.circuitdao.com/earn). The prevailing yield expressed as an annual percentage yield (APY) is shown near the top right of the page.

There are two ways of getting hold of Bytecash:

* Borrow BYC directly from the protocol on the [Borrow page](https://app.circuitdao.com/borrow).[^1]

* Buy BYC on the open market, for example on [Dexie](https://dexie.space).


## Deposit Bytecash

To start earning yield, click on Deposit, enter the desired amount of BYC and a fee in mojos per unit of [costs](https://docs.chia.net/coin-set-costs), and click Deposit.
