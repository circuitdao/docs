...
Frequently used numbers are defined as constants, since constants are referenced directly whereas numbers are spun up as Chialisp programs. For example
```
